...
use enrol_wallet\form\coupons_upload;
use enrol_wallet\local\coupons\uploadcoupon\processor;
use enrol_wallet\local\coupons\uploadcoupon\tracker;
...
if ($data = $form->get_data()) {
    ...
    $processor = new processor($cir, $data->allowed ?? 'all');
    echo $OUTPUT->heading(get_string('upload_result', 'enrol_wallet'));
    $processor->execute(new tracker(tracker::OUTPUT_HTML));
