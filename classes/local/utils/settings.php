...
class settings {
    ...
    protected function load_source_settings_tab(admin_settingpage $page) {
        ...
        if (!empty($creditplugin)) {
            ...
            if (!empty($countenrol + $countcredit)) {
                ...
                $page->add(new admin_setting_heading('enrol_wallet_migration',
                                                        '',
                                                    $migration));
            }
        }
        ...
        $page->hide_if('enrol_wallet/wp_notice', 'enrol_wallet/walletsource',
                                                    'eq', balance::MOODLE);

        $page->add(new admin_setting_configcheckbox('enrol_wallet/wordpressloggins',
                                                    get_string('wordpressloggins', 'enrol_wallet'),
                                                    get_string('wordpressloggins_desc', 'enrol_wallet'),
                                                    0));
        $page->hide_if('enrol_wallet/wordpressloggins', 'enrol_wallet/walletsource',
                                                    'eq', balance::MOODLE);
        // Define the WordPress site URL configuration setting.
        $page->add(new admin_setting_configtext('enrol_wallet/wordpress_url',
        ...
        // Secret shared key.
        $page->add(new admin_setting_configtext('enrol_wallet/wordpress_secretkey',
                                                    get_string('wordpress_secretkey', 'enrol_wallet'),
                                                    get_string('wordpress_secretkey_help', 'enrol_wallet'),
                                                    'S0mTh1ng/123'
                                                    ));
        $page->hide_if('enrol_wallet/wordpress_secretkey', 'enrol_wallet/walletsource',
                                                    'eq', balance::MOODLE);
    }
    ...
    protected function load_generalenrolsetting_settings_tab(admin_settingpage $page) {
        ...
        $page->add(new admin_setting_heading('enrol_wallet_generalenrolsetting', get_string('generalenrolsetting', 'enrol_wallet')
                                                , ''));
        ...
        $page->add(new admin_setting_configselect('enrol_wallet/expiredaction',
        ...
        $page->add(new admin_setting_configselect('enrol_wallet/expirynotifyhour',
            get_string('expirynotifyhour', 'core_enrol'), '', 6, $options));
        // Options for multiple instances.
        $page->add(new admin_setting_configtext('enrol_wallet/allowmultipleinstances',
        ...
        $page->add(new admin_setting_configcheckbox('enrol_wallet/unenrolselfenabled',
        ...
        $page->add(new admin_setting_configduration('enrol_wallet/unenrollimitafter',
        ...
        $page->add(new admin_setting_configduration('enrol_wallet/unenrollimitbefor',
                            get_string('unenrollimitbefor', 'enrol_wallet'),
                            get_string('unenrollimitbefor_desc', 'enrol_wallet'),
                            0));
        // Repurchase.
        $page->add(new admin_setting_heading('enrol_wallet_repurchase',
                                                get_string('repurchase', 'enrol_wallet'),
                                                get_string('repurchase_desc', 'enrol_wallet')));
        $page->add(new admin_setting_configcheckbox('enrol_wallet/repurchase',
                                                get_string('repurchase', 'enrol_wallet'), '', 0));
        $page->add(new admin_setting_configtext('enrol_wallet/repurchase_firstdis',
                                                get_string('repurchase_firstdis', 'enrol_wallet'),
                                                get_string('repurchase_firstdis_desc', 'enrol_wallet'),
                                                0, PARAM_INT));
        $page->add(new admin_setting_configtext('enrol_wallet/repurchase_seconddis',
    ...
    protected function load_display_settings_tab(admin_settingpage $page) {
        ...
        $page->add(new admin_setting_configcheckbox('enrol_wallet/showprice',
                            get_string('showprice', 'enrol_wallet'),
                            get_string('showprice_desc', 'enrol_wallet'),
                            0));
        $page->add(new admin_setting_configcheckbox('enrol_wallet/mywalletnav',
                                                        get_string('mywalletnav', 'enrol_wallet'),
                                                        get_string('mywalletnav_desc', 'enrol_wallet'),
                                                        '0'));
        $page->add(new admin_setting_configcheckbox('enrol_wallet/frontpageoffers',
                                                get_string('frontpageoffers', 'enrol_wallet'),
                                                get_string('frontpageoffers_desc', 'enrol_wallet'), 0));


        $page->add(new admin_setting_configcheckbox('enrol_wallet/offers_nav',
                                                        get_string('offersnav', 'enrol_wallet'),
                                                        get_string('offersnav', 'enrol_wallet'),
                                                        '0'));

        // Add low balance notification settings.
        $page->add(new admin_setting_heading('enrol_wallet_notify',
                                                get_string('lowbalancenotify', 'enrol_wallet'),
                                                get_string('lowbalancenotify_desc', 'enrol_wallet')));

        $page->add(new admin_setting_configcheckbox('enrol_wallet/lowbalancenotice',
                                                get_string('lowbalancenotice', 'enrol_wallet'), '', 0));

        $page->add(new admin_setting_configtext('enrol_wallet/noticecondition',
    ...
    protected function load_wallet_balance_coupons_settings_tab(admin_settingpage $page) {
        ...
        // Add custom currency.
        $page->add(new admin_setting_configtext_with_maxlength('enrol_wallet/customcurrencycode',
                                                    get_string('customcurrencycode', 'enrol_wallet'),
                                                    get_string('customcurrencycode_desc', 'enrol_wallet'), '', PARAM_TEXT, 5, 3));
        $page->add(new admin_setting_configtext('enrol_wallet/customcurrency',
        ...
        $page->add(new admin_setting_configcheckbox('enrol_wallet/catbalance',
                            'Category balance',
                            'Enable category balance',
                            1));
        ...
        $page->add(new admin_setting_configmulticheckbox('enrol_wallet/coupons',
    ...
    protected function load_refund_settings_tab(admin_settingpage $page) {
        ...
        $page->add(new admin_setting_confightmleditor('enrol_wallet/unenrolrefundpolicy',
        ...
        // Manual Refunding.
        $page->add(new admin_setting_heading('enrol_wallet_refund',
                            get_string('refundpolicy', 'enrol_wallet'),
                            ''));
        // Refund policy.
        $page->add(new admin_setting_confightmleditor('enrol_wallet/refundpolicy',
                            get_string('refundpolicy', 'enrol_wallet'),
                            get_string('refundpolicy_help', 'enrol_wallet'),
                            get_string('refundpolicy_default', 'enrol_wallet')));
        // Enable refunding.
        $page->add(new admin_setting_configcheckbox('enrol_wallet/enablerefund',
                            get_string('enablerefund', 'enrol_wallet'),
                            get_string('enablerefund_desc', 'enrol_wallet'),
                            1));
        // Refunding grace period.
        $page->add(new admin_setting_configduration('enrol_wallet/refundperiod',
    ...
    protected function load_transfer_settings_tab(admin_settingpage $page) {
        ...
        $page->add(new admin_setting_heading('enrol_wallet_transfer',
                            get_string('transfer', 'enrol_wallet'),
                            get_string('transfer_desc', 'enrol_wallet')));
        // Enable or disable transfer.
        $page->add(new admin_setting_configcheckbox('enrol_wallet/transfer_enabled',
                            get_string('transfer_enabled', 'enrol_wallet'),
                            get_string('transfer_enabled_desc', 'enrol_wallet'),
                            0));
        // Min transfer amount.
        $page->add(new admin_setting_configtext('enrol_wallet/mintransfer',
                            get_string('mintransfer_config', 'enrol_wallet'),
                            get_string('mintransfer_config_desc', 'enrol_wallet'),
                            0, PARAM_FLOAT));
        // Transfer fee.
        $page->add(new admin_setting_configtext_with_maxlength('enrol_wallet/transferpercent',
        ...
        $page->add(new admin_setting_configselect('enrol_wallet/transferfee_from',
    ...
    protected function load_wallet_discounts_settings_tab(admin_settingpage $page) {
        ...
        $page->add(new admin_setting_configcheckbox('enrol_wallet/conditionaldiscount_apply',
        ...
        $page->add(new admin_setting_description('conditionaldiscount',
    ...
    protected function load_purchase_discounts_settings_tab(admin_settingpage $page) {
        ...
        $page->add(new admin_setting_configselect('enrol_wallet/discount_behavior',
        ...
        $page->add(new admin_setting_configselect('enrol_wallet/discount_field',
    ...
    protected function load_freegifts_settings_tab(admin_settingpage $page) {
        ...
        $page->add(new admin_setting_heading('enrol_wallet_cashback',
            get_string('walletcashback', 'enrol_wallet'), get_string('walletcashback_desc', 'enrol_wallet')));
        // Enable cashback.
        $page->add(new admin_setting_configcheckbox('enrol_wallet/cashback',
            get_string('cashbackenable', 'enrol_wallet'), get_string('cashbackenable_desc', 'enrol_wallet'), 0));
        // Cashback percentage value.
        $page->add(new admin_setting_configtext_with_maxlength('enrol_wallet/cashbackpercent',
    ...
    protected function load_borrow_settings_tab(admin_settingpage $page) {
        ...
        $page->add(new admin_setting_heading('enrol_wallet_borrow',
                                                get_string('borrow', 'enrol_wallet'),
                                                get_string('borrow_desc', 'enrol_wallet')));
        // Enable Borrow.
        $page->add(new admin_setting_configcheckbox('enrol_wallet/borrowenable',
        ...
        $page->add(new admin_setting_configtext_with_maxlength('enrol_wallet/borrowtrans',
        ...
        $page->add(new admin_setting_configduration('enrol_wallet/borrowperiod',
    ...
    protected function load_referral_settings_tab(admin_settingpage $page) {
        ...
        $page->add(new admin_setting_heading('enrol_wallet_referral',
                                                get_string('referral_program', 'enrol_wallet'),
                                                get_string('referral_program_desc', 'enrol_wallet')));
        // Enable referrals.
        $page->add(new admin_setting_configcheckbox('enrol_wallet/referral_enabled',
                                                get_string('referral_enabled', 'enrol_wallet'),
                                                '',
                                                0));
        // Referral value.
        $page->add(new admin_setting_configtext('enrol_wallet/referral_amount',
                                                get_string('referral_amount', 'enrol_wallet'),
                                                get_string('referral_amount_desc', 'enrol_wallet'),
                                                0,
                                                PARAM_FLOAT));
        // Maximum Referal times.
        $page->add(new admin_setting_configtext('enrol_wallet/referral_max',
        ...
        $page->add(new admin_setting_configmultiselect('enrol_wallet/referral_plugins',
    ...
    protected function load_restriction_settings_tab(admin_settingpage $page) {
        ...
        $page->add(new admin_setting_heading('enrol_wallet_conditions',
                                                get_string('restrictions', 'enrol_wallet'),
                                                get_string('restrictions_desc', 'enrol_wallet')));
        $page->add(new admin_setting_configcheckbox('enrol_wallet/restrictionenabled',
        ...
        if (!empty($options)) {
            $page->add(new admin_setting_configmultiselect('enrol_wallet/availability_plugins',
    ...
    protected function load_default_instance_settings_tab(admin_settingpage $page) {
        ...
        $page->add(new admin_setting_heading('enrol_wallet_defaults',
            get_string('enrolinstancedefaults', 'admin'), get_string('enrolinstancedefaults_desc', 'admin')));
        // Adding wallet instance automatically upon course creation.
        $page->add(new admin_setting_configcheckbox('enrol_wallet/defaultenrol',
        ...
        $page->add(new admin_setting_configselect('enrol_wallet/status',
        ...
        $page->add(new admin_setting_configselect('enrol_wallet/newenrols',
        ...
        $page->add(new admin_setting_configselect('enrol_wallet/sendcoursewelcomemessage',
        ...
        $page->add(new admin_setting_configcheckbox('enrol_wallet/awards',
                                                        get_string('awards', 'enrol_wallet'),
                                                        get_string('awards_help', 'enrol_wallet'),
                                                        0));
        // Awards conditions.
        $page->add(new admin_setting_configtext_with_maxlength('enrol_wallet/awardcreteria',
                                                                    ...
                                                                    2));
        // Award value.
        $page->add(new admin_setting_configtext('enrol_wallet/awardvalue', get_string('awardvalue', 'enrol_wallet'),
