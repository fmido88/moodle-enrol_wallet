...
class coupon extends base {
    ...
    protected function get_all_filters() {
        ...
        $filters[] = (new filter(
            ...
            $this->get_entity_name(),
            "{$calias}.type"
        ))->set_options(couponshelper::get_coupons_options());
        ...
        $filters[] = (new filter(
            ...
            $this->get_entity_name(),
            "{$calias}.id"
        ))->restrict_limited_operators([number::ANY_VALUE, number::EQUAL_TO, number::RANGE]);
    ...
    public function get_all_actions() {
        ...
        $actions[] = new action(
            url: new url('/enrol/wallet/extra/coupondelete.php', ['id' => ':id']),
