...
$string['balances_report'] = 'Balances report';
...
$string['coupon_disabled'] = 'Coupons of type \'{$a}\' are disabled in this site.';
...
$string['invalidoffersetop'] = 'Invalid offer set operation';
...
$string['offer_set'] = 'Set of offers';
$string['offer_set_desc'] = 'The offer of getting a {$a->discount} will be available when {$a->op} these conditions satisfied';
$string['offer_subset_desc'] = 'When {$a->op} these conditions satisfied';
$string['offer_type_not_available'] = 'The selected offer type {$a} is not available.';
$string['offers'] = 'Offers';
$string['offers_ce_desc'] = '{$a->discount} if you are enrolled in {$a->condition} of these courses:<br> {$a->courses}';
$string['offers_course_enrol_based'] = 'Another course enrolment based offer';
$string['offers_desc'] = 'Offers and Free courses';
$string['offers_discountpercent'] = '<strong>{$a}% DISCOUNT</strong>';
...
$string['offers_nc_desc'] = '{$a->discount} if you are already enrolled in at least {$a->number} other courses inside the category {$a->catname}';
...
$string['offers_pf_desc'] = '{$a->discount} if your profile field "{$a->field}" {$a->op} "{$a->value}"';
...
$string['offers_time_desc'] = '{$a->discount} if you purchase this course in the period from {$a->from} to {$a->to}';
...
$string['suboffer'] = 'suboffer as a condition';
...
$string['totalfree'] = 'Total free gift';
$string['totalnonrefundable'] = 'Total non-refundable';
$string['totalrefundable'] = 'Total refundable';
...
$string['validbalance'] = 'Valid balance';
$string['validfree'] = 'Valid free';
$string['validfrom'] = 'Valid from';
$string['validnonrefundable'] = 'Valid non-refundable';
$string['validrefundable'] = 'Valid refundable';
