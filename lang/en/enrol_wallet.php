...
$string['referral_on_topup'] = 'Enable referral on wallet top-up';
$string['referral_on_topup_desc'] = 'If enabled, referral will be applied when a user tops up their wallet.';
$string['referral_topup_minimum'] = 'Minimum top-up amount for referral';
$string['referral_topup_minimum_desc'] = 'The minimum amount a user needs to top up their wallet to activate the referral credit.';
$string['referral_topup'] = 'Referral reward for wallet top-up by {$a}';
$string['referral_gift_topup'] = 'Referral gift for topping up wallet (referred by {$a})';
